...
routes (health, schema, inspect, pages), and global exception handlers. The
returned :class:`FastAPI` instance is fully self-contained — embed it in
tests or behind ASGI servers identically.
"""
...
from asmr_balance.web.routes import health, inspect, pages, schema
